...
function processCLIParamsAndExecute () {
  if (argv.length !== 4) {
    ...
    console.log('\n  node run start -- [path-and-filename-of-packages-file] [search-directory]')
    console.log('\nwhere...')
    console.log('  - [path-and-filename-of-packages-file] is the path/filename of a file containing a list of packages you want to search for. This file should consist of one or more lines, each consisting of a package name, followed by an \'@\', followed by the version you\'re looking for.')
