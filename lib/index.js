...
function processCLIParamsAndExecute () {
  if (argv.length !== 4) {
    ...
    console.log('\nwhere...')
    console.log('  - [packages-file] is the path and filename of the file containing the packages you want to search for. This file should consist of one or more lines, each consisting of a package name, followed by an \'@\', followed by the version you\'re looking for.')
