...
module.exports = {
  async search (searchDirectory, packageJsonFiles, targetDependencies) {
    ...
    console.log(`  - number of package.json files found with a target dependencies, but with a different version: ${packageMatchCount}`)
    console.log(`  - number of package.json files found with a target dependencies of the specified version: ${packageAndVersionMatchCount}`)
  }
}
